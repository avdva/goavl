...
func (lc *simpleLocationCache[K, V]) new(k K, v V) ptrLocation[K, V] {
	pn := &ptrNode[K, V]{}
	pn.init(k, v)
...
func (lc *simpleLocationCache[K, V]) release(ptrLocation[K, V]) {}
...
func (lc *pooledLocationCache[K, V]) new(k K, v V) ptrLocation[K, V] {
...
func (lc *pooledLocationCache[K, V]) release(loc ptrLocation[K, V]) {
